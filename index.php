...
<body>
    <div class="title">
        <span style="color:white;" >GYAN PUBLIC SCHOOL</span>
    </div>
    ...
    <div class="main">
        <div class="faculty-login">
            <form action="" method="POST" name="login">
                <fieldset>
                    <legend class="heading" style="font-weight:500; font-size:40px color:white;">Staff Login</legend>
        ...
        <div class="result">
            <form action="Student_result.php" method="GET">
                <fieldset>
                    <legend class="heading" style="font-weight:500; font-size:40px color:white;">Students Login</legend>
